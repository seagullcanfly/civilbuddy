                ...
                <h5 className="mb-1 text-primary">
                    {item.specCode ? (
                        <a 
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="hover-underline d-inline-flex align-items-center"
                        >
                            {item.title} 
                            <small className="text-muted ms-2 fw-normal" style={{ fontSize: '0.85em' }}>({formattedCode})</small>
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-box-arrow-up-right ms-2 text-muted opacity-75" viewBox="0 0 16 16">
