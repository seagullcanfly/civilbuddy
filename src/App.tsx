...
// Constants - These are static for Suffolk County / SCPD
...
function App() {
  ...
  // Default to Step S when title changes
  useEffect(() => {
    ...
    <div className="container mt-5" style={{ maxWidth: '900px' }}>
      <div className="card shadow-lg border-0">
        <div className="card-header bg-primary text-white text-center py-4">
          <h2 className="mb-0 fw-bold">Civil Buddy Salary Calculator</h2>
          <p className="mb-0 opacity-75">Suffolk County Civil Service Verification Tool</p>
        </div>
        ...
        <div className="card-body p-4">
          ...
          {results ? (
            ...
            <div className="text-center py-5 text-muted bg-light rounded">
              ...
              <p>You can also adjust the Step to verify specific hire rates.</p>
            </div>
          )}
